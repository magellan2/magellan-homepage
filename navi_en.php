...
<?php } ?>
    ...
    <p>
        <a href="download_en.php">Download</a><br /> <a class="sublink"
            href="download_en.php#magellan2">Magellan 2.x</a>&nbsp;&middot;&nbsp;&nbsp;<br /> <a
            class="sublink" href="download_en.php#magellan1">Magellan 1.x</a>&nbsp;&middot;&nbsp;&nbsp;<br />
    </p>
    <p>
    ...
    <p>
        <a href="tools_en.php">Tools</a><br /> <a class="sublink" href="tools_consolemerger_en.php">Console
            Merger</a>&nbsp;&middot;&nbsp;&nbsp;<br />
    </p>
    <p>
        <a class="externalLink" href="https://magellan2.github.io/bugs/">Report a bug</a>
    </p>
    <p>
        <a class="externalLink" href="https://github.com/magellan2/magellan2">Code at Github</a>
    </p>
    <p>
