...
<head>
    ...
    ?>
    <title>Magellan Plugins - LightHouseIcons Plugin</title>
</head>
<body>
    <div id="container">
      <?php
      ...
      <div id="center">
            ...
            <table summary="" cellspacing="0" cellpadding="1" border="0" class="plugin">
                ...
                <tr class="plugin">
                    ...
                    <td class="plugin">Tatsächlich gesehene Regionen und maximale Reichweite
                        freundlicher und andere Leuchttürme wird angezeigt.</td>
                </tr>
                <tr class="plugin">
                ...
                <tr class="plugin">
                    ...
                    <td class="plugin"><a href="download_de.php#lighthouseicons">https://magellan.narabi.de</a>
                    </td>
                </tr>
            </table>
            <p>
            ...
            <hr>
                <table border=0>
                    <tr>
                        <td bgcolor=blue><img src="images/LHIplugin_lh.gif" alt="MapIcon Leuchtturm"
                            border="0" /></td>
                    ...
                    <tr>
                        <td bgcolor=blue><img src="images/LHIplugin_lh_range.gif"
                            alt="MapIcon Monster" border="0" /></td>
                        <td>Diese Region liegt in Reichweite eines "freundlichen" Leuchtturms,
                            ...
                            </ul> (In den ersten beiden Fällen hat die Sichtbarkeit durch
                    ...
                    <tr>
                        <td bgcolor=blue><img src="images/LHIplugin_lh_range_other.gif"
                            alt="MapIcon Monster" border="0" /></td>
