...
<?php } ?>
    ...
    <p>
        <a href="download_de.php">Download</a><br /> <a class="sublink"
            href="download_de.php#magellan2">Magellan 2.x</a>&nbsp;&middot;&nbsp;&nbsp;<br />
    ...
    <p>
        <a href="plugins_de.php">Plugins</a><br /> <a class="sublink"
            href="plugins_alliance_de.php">Alliance Plugin</a>&nbsp;&middot;&nbsp;&nbsp;<br />
        <a class="sublink" href="plugins_extcmds_de.php">ExtCmds Plugin</a>&nbsp;&middot;&nbsp;&nbsp;<br />
        <a class="sublink" href="plugins_fow_update_de.php">FoW-Update
            Plugin</a>&nbsp;&middot;&nbsp;&nbsp;<br /> <a
            class="sublink" href="plugins_lighthouseicons_de.php">Lighthouse
            Plugin</a>&nbsp;&middot;&nbsp;&nbsp;<br /> <a
            class="sublink" href="plugins_mapcleaner_de.php">MapCleaner
            Plugin</a>&nbsp;&middot;&nbsp;&nbsp;<br /> <a
            class="sublink" href="plugins_mapedit_de.php">MapEdit Plugin</a>&nbsp;&middot;&nbsp;&nbsp;<br />
        <a class="sublink" href="plugins_mapicons_de.php">MapIcons
            Plugin</a>&nbsp;&middot;&nbsp;&nbsp;<br /> <a
            class="sublink" href="plugins_memorywatch_de.php">MemWatch
            Plugin</a>&nbsp;&middot;&nbsp;&nbsp;<br /> <a
            class="sublink" href="plugins_statistics_de.php">Statistics
            Plugin</a>&nbsp;&middot;&nbsp;&nbsp;<br /> <a
            class="sublink" href="plugins_teacher_de.php">Teacher Plugin</a>&nbsp;&middot;&nbsp;&nbsp;<br />
    </p>
    <p>
        <a href="tools_de.php">Tools</a><br /> <a class="sublink"
            href="tools_consolemerger_de.php">Console Merger</a>&nbsp;&middot;&nbsp;&nbsp;<br />
    </p>
    <p>
    ...
    <p>
        <a class="externalLink"
            href="https://magellan2.github.io/bugs/">Fehler melden</a>
    </p>
    <p>
